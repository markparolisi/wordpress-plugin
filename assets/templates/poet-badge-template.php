<?php
/**
 * Template to display the Po.et badge via the poet-badge shortcode.
 *
 * @package Poet
 */
...
<div class="poet-badge">
	...
	<div class="poet-badge__container">
		<img class="poet-badge__container__image" src="<?php echo esc_url( $quill_image_url ); ?>" height="31"
			 width="31" rel="poet-badge" title="poet-badge">
